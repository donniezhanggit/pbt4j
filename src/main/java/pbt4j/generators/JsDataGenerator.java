 ...
 */
public class JsDataGenerator extends Generator<Object> {
    ...
    public JsDataGenerator(Type typ, String[] values, ScriptContext scriptContext) {
        super(Object.class);
        this.typ = typ;
    ...
    public static Object evalJs(String jsScript, ScriptContext scriptContext) {
        try {
            return engine.eval(jsScript, scriptContext);
    ...
    protected Object convertFromMirror(Class<?> toClass, ScriptObjectMirror fromMirror) {
        ...
        } else throw new UnsupportedOperationException("Unsupported type: " + toClass);
    }
}
